...
const Sidebar = () => {
    ...
    console.log('is delivery: ', isDeliveryMan);
    ...
    const deliveryMenus = [
        { name: 'My Delivery List', link: 'my-delivery-list', icon: AiOutlineShoppingCart },
        { name: 'My Reviews', link: 'my-reviews', icon: HiOutlineBookOpen }
    ]
